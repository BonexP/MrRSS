...
const en: TranslationMessages = {
  ...
  feedProxyDesc: 'Use custom proxy for this feed (overrides global setting)',
  ...
  feedRefreshIntervalDesc: 'Custom refresh interval for this feed (0 = use global)',
  feedRefreshIntervalPlaceholder: 'Minutes (0 for global setting)',
