...
const en: TranslationMessages = {
  ...
  setting: {
    ...
    miniflux: {
      apiKey: 'API Key',
      apiKeyDesc: 'Miniflux API key from your account settings',
      apiKeyPlaceholder: 'Enter your Miniflux API key',
      connectionFailed: 'Connection failed',
      connectionSuccess: 'Connection successful',
      daysAgo: '{count} days ago',
      disableConfirm:
        'Disabling Miniflux will delete local Miniflux feeds and articles. This action cannot be undone. Are you sure you want to continue?',
      enabled: 'Miniflux Integration',
      enabledDesc: 'Sync feeds and articles with a Miniflux server',
      feedLocked: 'Miniflux feed cannot be edited, moved, or modified',
      hoursAgo: '{count} hours ago',
      justNow: 'Just now',
      lastSync: 'Last Sync',
      minsAgo: '{count} minutes ago',
      never: 'Never',
      serverUrl: 'Server URL',
      serverUrlDesc: 'Miniflux server endpoint (without /v1 path)',
      ...
      testConnectionDesc: 'Verify Miniflux server and API key',
    },
    plugins: {
      notion: {
        apiKey: 'API Key',
