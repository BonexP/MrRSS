...
const zh: TranslationMessages = {
  ...
  setting: {
    ...
    miniflux: {
      apiKey: 'API 密钥',
      apiKeyDesc: 'Miniflux API 密钥，从账户设置中获取',
      apiKeyPlaceholder: '输入 Miniflux API 密钥',
      connectionFailed: '连接失败',
      connectionSuccess: '连接成功',
      daysAgo: '{count} 天前',
      disableConfirm:
        '禁用 Miniflux 将删除本地的 Miniflux 订阅源和文章。此操作不可撤销。确定要继续吗？',
      enabled: 'Miniflux 集成',
      enabledDesc: '与 Miniflux 服务器同步订阅源和文章',
      feedLocked: 'Miniflux 订阅源无法编辑、移动或修改',
      hoursAgo: '{count} 小时前',
      justNow: '刚刚',
      lastSync: '上次同步',
      minsAgo: '{count} 分钟前',
      never: '从未',
      serverUrl: '服务器地址',
      serverUrlDesc: 'Miniflux 服务器端点（不含 /v1 路径）',
      ...
      test: '测试',
      testConnection: '测试连接',
      testConnectionDesc: '验证 Miniflux 服务器和 API 密钥',
    },
    plugins: {
      notion: {
        apiKey: 'API 密钥',
