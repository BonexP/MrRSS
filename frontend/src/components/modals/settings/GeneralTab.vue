            ...
            <div class="setting-item mt-2 sm:mt-3">
                <div class="flex-1 flex items-start gap-2 sm:gap-3 min-w-0">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-xs text-text-secondary hidden sm:block">{{ t('defaultViewModeDesc') }}</div>
                    </div>
                </div>
        ...
        <div class="setting-group">
            ...
            <div class="setting-item">
                <div class="flex-1 flex items-start gap-2 sm:gap-3 min-w-0">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-xs text-text-secondary hidden sm:block">{{ t('autoUpdateIntervalDesc') }}</div>
                    </div>
                </div>
            ...
            <div class="info-display mt-2 sm:mt-3">
                <div class="flex items-center gap-2">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="text-xs sm:text-sm text-text-secondary truncate">{{ t('lastArticleUpdate') }}</div>
                    </div>
            ...
            <div class="setting-item mt-2 sm:mt-3">
                <div class="flex-1 flex items-start gap-2 sm:gap-3 min-w-0">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-xs text-text-secondary hidden sm:block">{{ t('startupOnBootDesc') }}</div>
                    </div>
                </div>
            ...
            <div class="setting-item">
                <div class="flex-1 flex items-start gap-2 sm:gap-3 min-w-0">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-xs text-text-secondary hidden sm:block">{{ t('autoCleanupDesc') }}</div>
                    </div>
                </div>
                ...
                <div class="sub-setting-item">
                    <div class="flex-1 flex items-start gap-2 sm:gap-3 min-w-0">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="text-xs text-text-secondary hidden sm:block">{{ t('maxCacheSizeDesc') }}</div>
                        </div>
                    </div>
                ...
                <div class="sub-setting-item">
                    <div class="flex-1 flex items-start gap-2 sm:gap-3 min-w-0">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="text-xs text-text-secondary hidden sm:block">{{ t('maxArticleAgeDesc') }}</div>
                        </div>
                    </div>
                    <div class="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <div class="setting-item mt-2 sm:mt-3">
                <div class="flex-1 flex items-start gap-2 sm:gap-3 min-w-0">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-xs text-text-secondary hidden sm:block">{{ t('showHiddenArticlesDesc') }}</div>
                    </div>
                </div>
            ...
            <div class="setting-item mb-2 sm:mb-4">
                <div class="flex-1 flex items-start gap-2 sm:gap-3 min-w-0">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-xs text-text-secondary hidden sm:block">{{ t('enableTranslationDesc') }}</div>
                    </div>
                </div>
                ...
                <div class="sub-setting-item">
                    <div class="flex-1 flex items-start gap-2 sm:gap-3 min-w-0">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="text-xs text-text-secondary hidden sm:block">{{ t('translationProviderDesc') || 'Choose the translation service to use' }}</div>
                        </div>
                    </div>
                ...
                <div v-if="settings.translation_provider === 'deepl'" class="sub-setting-item">
                    <div class="flex-1 flex items-start gap-2 sm:gap-3 min-w-0">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="text-xs text-text-secondary hidden sm:block">{{ t('deeplApiKeyDesc') || 'Enter your DeepL API key' }}</div>
                        </div>
                    </div>
                    <input type="password" v-model="settings.deepl_api_key" :placeholder="t('deeplApiKeyPlaceholder')" class="input-field w-32 sm:w-48 text-xs sm:text-sm">
                </div>
                ...
                <div class="sub-setting-item">
                    <div class="flex-1 flex items-start gap-2 sm:gap-3 min-w-0">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="text-xs text-text-secondary hidden sm:block">{{ t('targetLanguageDesc') || 'Language to translate article titles to' }}</div>
                        </div>
                    </div>
