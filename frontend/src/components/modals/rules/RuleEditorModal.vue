...
import { 
    PhLightning, PhPlus, PhFunnel, PhListChecks
...
import { useRuleOptions, type Condition, isMultiSelectField } from '@/composables/useRuleOptions';
import { useRuleConditions } from '@/composables/useRuleConditions';
                    ...
                    <div v-else class="space-y-3">
                        <div v-for="(condition, index) in conditions" :key="condition.id">
                            ...
                            <RuleConditionItem
                                ...
                                @update:field="(value) => { condition.field = value; handleFieldChange(index); }"
